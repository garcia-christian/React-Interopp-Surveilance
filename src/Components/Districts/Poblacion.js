...
const Poblacion = () => {
  ...
  const loadData = async () => {
    try {
      const respo = await fetch("https://centralserver-production.up.railway.app/dept-data/diseasesurv/disease-dist/11")
      const jData = await respo.json();
      const respo1 = await fetch("https://centralserver-production.up.railway.app/dept-data/diseasesurv/districts/11")
  ...
  return (
    <div  >
      <Card style={{ width: '18rem' }}>
        <Card.Body>
          <Card.Title>Poblacion</Card.Title>
