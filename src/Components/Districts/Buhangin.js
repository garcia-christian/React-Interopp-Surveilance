...
const Buhangin = () => {
  ...
  const loadData = async () => {
    try {
      const respo = await fetch("https://centralserver-production.up.railway.app/dept-data/diseasesurv/disease-dist/7")
      const jData = await respo.json();
      const respo1 = await fetch("https://centralserver-production.up.railway.app/dept-data/diseasesurv/districts/7")
  ...
  return (
    <div  >
      <Card style={{ width: '18rem' }}>
        <Card.Body>
          <Card.Title>Buhangin</Card.Title>
