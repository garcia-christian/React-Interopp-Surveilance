...
const Paquibato = () => {
  ...
  const loadData = async () => {
    try {
      const respo = await fetch("https://centralserver-production.up.railway.app/dept-data/diseasesurv/disease-dist/1")
      const jData = await respo.json();
      const respo1 = await fetch("https://centralserver-production.up.railway.app/dept-data/diseasesurv/districts/1")
  ...
  return (
    ...
    <Card style={{ width: '18rem' }}>
      <Card.Body>
        <Card.Title>Paquibato</Card.Title>
