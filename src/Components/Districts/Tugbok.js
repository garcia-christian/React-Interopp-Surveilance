...
const Tugbok = () => {
    ...
    const loadData = async () => {
      try {
        const respo = await fetch("https://centralserver-production.up.railway.app/dept-data/diseasesurv/disease-dist/4")
        const jData = await respo.json();
        const respo1 = await fetch("https://centralserver-production.up.railway.app/dept-data/diseasesurv/districts/4")
